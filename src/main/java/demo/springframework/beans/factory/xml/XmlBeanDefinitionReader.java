...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
		...
		for (int i = 0; i < childNodes.getLength(); i++) {
			...
			String initDataMethod = bean.getAttribute("init-method");
			String destroyDataMethod = bean.getAttribute("destroy-method");
			// 获取 Class，方便获取类中的名称
			...
			beanDefinition.setInitMethodName(initDataMethod);
			beanDefinition.setDestroyMethodName(destroyDataMethod);
			// 读取属性并填充
